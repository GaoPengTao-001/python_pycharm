...
credentials = pika.PlainCredentials('gaopengtao', 'gaopengtao')  # mq用户名和密码
# 虚拟队列需要指定参数 virtual_host，如果是默认的可以不填。
connection = pika.BlockingConnection(pika.ConnectionParameters(host = '192.168.31.55',port = 5672,virtual_host = '/',credentials = credentials))
